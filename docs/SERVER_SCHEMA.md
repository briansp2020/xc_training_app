...
7. **GPS routes are missing.** Strava, Fitbit, and most third-party apps don't write `ExerciseRouteRecord` to Health Connect. If you need GPS for pace-per-segment analysis, plan Strava OAuth server-side as a follow-up.
